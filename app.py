...
try:
    ...
    # This is the proper way to pass credentials to dagshub.init in non-interactive environments.
    os.environ['DAGSHUB_USER'] = DAGSHUB_USER
    os.environ['DAGSHUB_PASSWORD'] = DAGSHUB_TOKEN 
    
    # 2. Initialize DagsHub 
    # The 'token' argument is REMOVED to fix the 'unexpected keyword argument' error.
    dagshub.init(
